<script lang="ts">
	 ...
	 * - Joint Investigation (primary action)
	...
	let { onCoordinationClick, onTechShopClick, onFilteringClick }: Props = $props();
</script>

<div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
	<!-- Joint Investigation Button (US-2.7) -->
	<button
	...
	>
		...
		<div class="flex-1 text-left">
			<div class="font-bold text-gray-800 text-base mb-1">Joint Investigation</div>
			<div class="text-xs text-gray-500">Coordinate with other destinations</div>
		</div>
