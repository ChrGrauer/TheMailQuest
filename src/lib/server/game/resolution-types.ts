...
export interface RevenueParams {
	...
	clientStates: Record<string, ClientState>;
	deliveryRate: number;
	currentRound?: number; // Needed to determine modifier applicability
	// Per-client cumulative volume multipliers (includes warmup, incidents like INC-011, INC-015, etc.)
	// Calculated from all applicable volumeModifiers in clientState
	perClientVolumeMultipliers?: Record<string, number>;
}
