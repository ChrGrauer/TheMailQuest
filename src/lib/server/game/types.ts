 ...
 * Phase 5: Incident Choices (added pending_incident_choices array to ESPTeam for multiple concurrent choices)
 */
...
export interface ESPTeam {
	...
	// Phase 5: Incident Choices (supports multiple concurrent choices)
	pending_incident_choices?: Array<{
